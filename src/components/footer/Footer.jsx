    ...
    <div>
      <div className="bg-primary text-center text-white">
        <Container className="py-6">
          <code className="fs-8 LSpace-1 text-white  ">
            35,000+ ALREADY JOINED
          </code>
          <Row className="justify-content-center py-5">
            <Col xs={10} sm={9} md={6} xl={5}>
          ...
          <Col>
            <Form
              ...
              className="d-flex flex-column flex-md-row justify-content-md-center align-items-md-start"
            >
              <Form.Group controlId="formBasicEmail" className="me-md-4">
                <Form.Control
                  type="email"
                  placeholder="Enter your email address"
                  className="py-2 me-md-3 not-valid"
                  value={value}
                  onChange={(e)=>setValue(e.target.value)}
                />
                <Form.Control.Feedback
                  type="invalid"
                  className="bg-secondary text-white mt-0 py-2"
                >
              ...
              <Button
                variant="secondary"
                type="submit"
                className="py-2 mt-3 mt-md-0 px-md-4 text-white"
              >
                Contact Us
              </Button>
            </Form>
        ...
        <Container>
          <Navbar>
            <Container className='flex-column flex-md-row'>
              <Nav className="me-md-auto me-0 align-items-center flex-column flex-md-row  my-3">
              ...
              <Nav className='my-3'>
                <Nav.Link href="#facebook" className='px-4'>
                  <img src={facebook} alt="" />
                </Nav.Link>
                <Nav.Link eventKey={2} href="#twitter" className='px-4'>
                  <img src={twitter} alt="" />
                </Nav.Link>
              </Nav>
            </Container>
